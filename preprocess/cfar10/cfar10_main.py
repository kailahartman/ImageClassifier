...
def cfar10_read_save_locally_numpy_csv():
    ...
    image_dir = os.path.join(os.getcwd(),"..","preprocess", "data", "output_images_from_cifar10")
    # outside_dir = os.path.join(os.getcwd(), "..", "data")

    # save_cifar10_to_csv(image_dir, outside_dir)


    output_file_cifar10 = os.path.join(os.getcwd(), "data", "cifar10.csv")
    save_cifar_to_csv(train_labels, image_dir, output_file_cifar10, "cifar10")
